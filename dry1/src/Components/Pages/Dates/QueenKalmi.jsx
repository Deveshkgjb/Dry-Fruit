...
const QueenKalmi = () => {
  ...
  useEffect(() => {
    fetchQueenKalmiDates();
  }, []);

  const fetchQueenKalmiDates = async () => {
    try {
      setLoading(true);
      // Try API first, no fallback data
      try {
        const response = await productsAPI.getAll({ categorySlug: 'queen-kalmi' });
        setProducts(response.products || []);
      } catch (apiError) {
        console.log('API failed for queen kalmi dates...');
        setProducts([]);
      }
    } catch (error) {
      console.error('Error fetching queen kalmi dates:', error);
      setProducts([]);
    } finally {
      setLoading(false);
    }
  ...
  const getFallbackQueenKalmiDates = () => [
    {
      id: 1,
      name: "Happilo Premium Queen Kalmi Dates",
      image: "/dev1.png",
      weight: "500g",
      price: 399,
      originalPrice: 499,
    ...
    {
      id: 2,
      name: "Happilo Organic Queen Kalmi Dates",
      image: "/dev2.png",
      weight: "1kg",
      price: 749,
      originalPrice: 899,
    ...
    {
      id: 3,
      name: "Happilo Soft Queen Kalmi Dates",
      image: "/dev1.png",
      weight: "250g",
      price: 249,
      originalPrice: 299,
    ...
    {
      id: 4,
      name: "Happilo Natural Queen Kalmi Dates",
      image: "/dev2.png",
      weight: "750g",
      price: 549,
      originalPrice: null,
    ...
    {
      id: 5,
      name: "Happilo Premium Queen Kalmi Mix",
      image: "/dev1.png",
      weight: "2kg",
      price: 1299,
      originalPrice: 1599,
    ...
    {
      id: 6,
      name: "Happilo Sweet Queen Kalmi Dates",
      image: "/dev2.png",
      weight: "300g",
      price: 299,
      originalPrice: 349,
      ...
      <div className="w-full min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8">
          <div className="flex items-center justify-center h-64">
            <div className="text-lg text-gray-600">Loading queen kalmi dates...</div>
          </div>
        </div>
        <Footer />
      </div>
    ...
    <div className="w-full min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-2xl font-bold">Queen Kalmi Dates</h1>
        ...
        <div className="mt-16 space-y-8">
          <div>
            <h2 className="text-3xl font-bold text-gray-800 mb-6">Premium Quality Queen Kalmi Dates Online from Happilo</h2>
            <p className="text-gray-600 leading-relaxed">
              Happilo provides a variety of Queen Kalmi dates which guarantee a premium-quality healthy snack at affordable prices. These rich and flavorful dates are packed with nutrients that boost your health functions, providing natural energy and supporting overall wellness.
            </p>
          </div>

          <div>
            <h3 className="text-2xl font-bold text-gray-800 mb-4">What are Queen Kalmi Dates?</h3>
            <p className="text-gray-600 leading-relaxed">
              Queen Kalmi dates are premium quality dates known for their exceptional taste, soft texture, and rich flavor. They are considered among the finest varieties of dates and are prized for their superior quality, natural sweetness, and nutritional benefits.
            </p>
          </div>

          <div>
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Health Benefits of Queen Kalmi Dates</h3>
